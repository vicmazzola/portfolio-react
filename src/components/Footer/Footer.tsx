        ...
        <div>
            <footer className="footer bg-transparent text-neutral-content items-center p-4">
                ...
                <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                    {/* GitHub Link */}
                    <a href="https://github.com/vicmazzola" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                        <svg
                    ...
                    {/* LinkedIn Link */}
                    <a href="https://www.linkedin.com/in/victor-mazzola-59aa291a0/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
